...
namespace Digger
{
    public static class EditorUtils
    {
        ...
        public static bool MicroSplatExists(Terrain terrain)
        {
            ...
            var mct = terrain.GetComponent<MicroSplatTerrain>();
            if (!mct)
                Debug.LogWarning("[Digger] Looks like you have MicroSplat in your project but the terrain doesn't use it. Is it intended?");
            return mct;
#else
            return false;
#endif
